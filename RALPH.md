...
## Stop Condition (CRITICAL - DIFFERENT FROM V1)

After completing **exactly ONE** user story (commit + PRD update + progress log), you must **EXIT IMMEDIATELY**.
...
**You MUST NOT work on more than one story per session.** Exit after the first story is complete.

## Important

- **ONE story per iteration, then EXIT** - the script will call you again for the next story
- Before changing code related to a feature, always use context7 to search for relevant docs.
- Commit frequently
- Keep CI green
